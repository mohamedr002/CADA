...
#    discriminator_optim =  adabound.AdaBound(discriminator.parameters(), lr=1e-5, final_lr=0.001)
#    target_optim =  adabound.AdaBound(target_encoder.parameters(), lr=1e-5, final_lr=0.001)
#    ncl_optim =  adabound.AdaBound(comput_ncl.parameters(), lr=1e-5, final_lr=0.001)
#    
    ...
    for epoch in range(1, da_params['epochs'][src_id] + 1):
        ...
        total_loss = 0
        total_accuracy = 0
        alpha =0#0.1#0.2#.2#0.2# 0.2
        beta = 0.001#0.2#0.001#0.2 
